...
public class StashRequestFacadeTest {
  ...
  public void setUp() throws Exception {
    ...
    when(config.getIssueSeverityThreshold()).thenReturn(Severity.MINOR);
    when(config.getIssueThreshold()).thenReturn(100);
  ...
  public void testPostTaskOnCommentWithNotPresentLevel() throws Exception {
    when(config.getIssueSeverityThreshold()).thenReturn(Severity.BLOCKER);
  ...
  public void testPostTaskOnCommentWithSeverityNone() throws Exception {
    when(config.getIssueSeverityThreshold()).thenReturn(StashPlugin.SEVERITY_NONE);
